...
interface LimitOrderProtocolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "checkPredicate(tuple)": FunctionFragment;
    "doublePrice(address,address,uint256,uint256)": FunctionFragment;
    "eq(uint256,address,bytes)": FunctionFragment;
    "fillOrder(tuple,bytes,uint256,uint256,uint256)": FunctionFragment;
    "fillOrderRFQ(tuple,bytes,uint256,uint256)": FunctionFragment;
    "fillOrderRFQTo(tuple,bytes,uint256,uint256,address)": FunctionFragment;
    "fillOrderRFQToWithPermit(tuple,bytes,uint256,uint256,address,bytes)": FunctionFragment;
    "fillOrderTo(tuple,bytes,uint256,uint256,uint256,address)": FunctionFragment;
    "fillOrderToWithPermit(tuple,bytes,uint256,uint256,uint256,address,bytes)": FunctionFragment;
...
export type OrderCanceledEvent = TypedEvent<
  [string, string] & { maker: string; orderHash: string }
>;
...
export class LimitOrderProtocol extends BaseContract {
  ...
  filters: {
    ...
    "OrderCanceled(address,bytes32)"(
      maker?: string | null,
      orderHash?: null
    ): TypedEventFilter<[string, string], { maker: string; orderHash: string }>;

...
interface WrappedTokenInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class WrappedTokenInterface extends BaseContract {
  ...
  interface: WrappedTokenInterfaceInterface;
